...
TARGET_SPECIFIC_HEADER_PATH := device/samsung/coreprimeltexx/include

# Kernel
BOARD_CUSTOM_BOOTIMG_MK      := device/samsung/coreprimeltexx/mkbootimg.mk
...
# Bluetooth
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/coreprimeltexx/bluetooth
BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_QCOM := true
BLUETOOTH_HCI_USE_MCT := true

# Custom RIL class
BOARD_RIL_CLASS := ../../../device/samsung/coreprimeltexx/ril/
...
# CMHW
BOARD_HARDWARE_CLASS += device/samsung/coreprimeltexx/cmhw
...
BOARD_SEPOLICY_DIRS += \
    device/samsung/coreprimeltexx/sepolicy
